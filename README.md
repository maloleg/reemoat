...
| `docs/DECISIONS.md` | **Why** any of it is that way. 1014 entries, question → decision, with the measurement behind each and the alternatives that were tried and taken back out |

...
| `docs/API.md` | The HTTP surface of both services — 113 routes, what each is for, and the conventions every one of them answers in |
...
| `docs/DECISIONS.md` | **Why** any of it is that way. 880 entries, question → decision, with the measurement behind each and the alternatives that were tried and taken back out |
